...
`docker run` 就是运行容器的命令，具体格式我们会在 [容器](../Docker容器) 一节进行详细讲解，我们这里简要的说明一下上面用到的参数。
...
>注意：如果您是初学者，您可以暂时跳过后面的内容，直接学习 [容器](../Docker容器) 一节。
...
![](http://cos.teanxo.cn/202209011755016.png)
...
![](http://cos.teanxo.cn/202209011755493.png)
